...
import { courseAllResources, resource, studentAllResources, userAllResources, userOwnResources } from "./resourcesBackend";
...
ROLE_ACCESSES.set('SECRETARY', [...userOwnResources, ...levelAllResources, ...studentAllResources, ...courseAllResources]);
